...
public class TreasuryDeptAuditor implements Runnable{
	...
	public TreasuryDeptAuditor(TheBankAccount jointAccount, String string ){
		agentName = string;
	...
	public void run() {
		while(true) {
			try {
				...
				theBankAccount.treasuryAudit();
			}
			catch( InterruptedException exception) {
				
				System.out.println("Exception thrown while Treasury Dept Auditing");
